...
-   `-P` permite especificar directorios donde buscar los directorios a _sourcear_ en caso de que shellcheck no pueda encontrarlos
...
wget -qO- ${url} | tar -xJv
cp "shellcheck-${SHELLCHECK_VERSION}/shellcheck" "${HOME}/bin/_shellcheck"
echo '_shellcheck -x --enable=all -P SCRIPTDIR "$@"' > "${HOME}/bin/shellcheck"
