...
La configuración de está muy bien documentada y hay bastantes issues abiertas:
...
En iCarto usamos bandit añadiendo el paquete a `requirements-dev.txt` y lanzándolo en pre-commit en en repo local:
...
En general no lo incluímos en el IDE porqué suelen ser problemas bien conocidos y fáciles de refactorizar cuando el código tiene cierta forma, pero incómodos durante el desarrollo en sí.
