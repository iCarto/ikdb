...
-   [black sobre git blame](https://github.com/psf/black#migrating-your-code-style-without-ruining-git-blame) Como evitar problemas al usar `git blame` tras formatear el código.
